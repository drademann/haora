...
func TestListWeekCmd(t *testing.T) {
	...
	d.AddTasks(
		data.NewTask(test.MockDate("22.02.2024 09:00"), "task 1"),
		data.NewPause(test.MockDate("22.02.2024 12:00"), "lunch"),
		data.NewTask(test.MockDate("22.02.2024 12:45"), "task 2"),
	)
...
func TestListWeekCmd_withTotalDuration(t *testing.T) {
	d1 := data.Day{Date: test.MockDate("22.02.2024 00:00")}
	d1.AddTasks(
		data.NewTask(test.MockDate("22.02.2024 09:00"), "task 1"),
		data.NewPause(test.MockDate("22.02.2024 12:00"), "lunch"),
		data.NewTask(test.MockDate("22.02.2024 12:45"), "task 2"),
	)
	d1.Finished = test.MockDate("22.02.2024 17:00")
	d2 := data.Day{Date: test.MockDate("23.02.2024 00:00")}
	d2.AddTasks(
		data.NewTask(test.MockDate("23.02.2024 10:30"), "task a"),
		data.NewPause(test.MockDate("23.02.2024 12:15"), "some bread"),
		data.NewTask(test.MockDate("23.02.2024 12:30"), "task b"),
	)
	d2.Finished = test.MockDate("23.02.2024 15:00")
